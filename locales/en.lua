local Translations = {
  ...
  commands = {
    ["save_character"] = "Save your character (Admin Only)",
    ...
    ["spawn_personal_vehicle"] = "Spawn Personal Vehicle (Admin Only)",
    ...
    ["teleport_coords"] = "Teleport to coords (Admin Only)",
    ...
    ["kill_radius"] = "Kill Players in radius (Admin Only)",
    ["freeze_target"] = "Freeze target player (Admin Only)",
    ["bring_target"] = "Freeze target player (Admin Only)",
    ["teleport_to_player"] = "Teleport to target player (Admin Only)",
    ["go_target_vehicle"] = "Teleport to target vehicle (Admin Only)",
    ["give_clothing_menu"] = "Give clothing menu to target player (Admin Only)",
    ["open_target_inventory"] = "Open target player inventory (Admin Only)",
